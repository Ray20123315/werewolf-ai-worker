(() => {
  ...
  languageSelect?.addEventListener("change", () => setTimeout(() => { localize(); applyPlayerView(); applyMessageView(); updateStats(); }, 0));
